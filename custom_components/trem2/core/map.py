...
TW_MAP_SVG = {
    ...
    "qrcode": '<g id="qrcode" transform="translate(870 10)"><rect width="120" height="120" fill="#fff" /><g transform="scale(0.27) translate(-27, -27)">{qr_code}</g></g>',
    "info": '<g id="information" transform="translate(10, 10)" font-family="Noto Sans TC, sans-serif" font-size="16px" fill="#fff" opacity="1"><rect width="300" height="390" fill="#2e364f" opacity="0.6" stroke-width="2" /><text x="150" y="50" fill="#f0f0f0" stroke="none" font-size="24px" text-anchor="middle" opacity="1">地震資訊</text><g transform="translate(20, 80)" stroke="none"><path d="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z" /><text x="30" y="18" fill="#eedaf2" font-size="20px">{eq_id}</text></g><g transform="translate(20, 120)" stroke="none"><path d="M12,11.5A2.5,2.5 0 0,1 9.5,9A2.5,2.5 0 0,1 12,6.5A2.5,2.5 0 0,1 14.5,9A2.5,2.5 0 0,1 12,11.5M12,2A7,7 0 0,0 5,9C5,14.25 12,22 12,22C12,22 19,14.25 19,9A7,7 0 0,0 12,2Z" /><text x="30" y="10" fill="#eedaf2"><tspan>{loc_main}</tspan><tspan x="30" dy="18">({loc_spec})</tspan></text></g><g transform="translate(20, 170)" stroke="none"><path d="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M16.2,16.2L11,13V7H12.5V12.2L17,14.9L16.2,16.2Z" /><text x="30" y="10"><tspan>發震時間 (UTC+8)</tspan><tspan x="30" dy="20" fill="#eedaf2" font-size="20px">{time}</tspan></text></g><g transform="translate(20, 220)" stroke="none"><path d="M5.41,21L6.12,17H2.12L2.47,15H6.47L7.53,9H3.53L3.88,7H7.88L8.59,3H10.59L9.88,7H15.88L16.59,3H18.59L17.88,7H21.88L21.53,9H17.53L16.47,15H20.47L20.12,17H16.12L15.41,21H13.41L14.12,17H8.12L7.41,21H5.41M9.53,9L8.47,15H14.47L15.53,9H9.53Z" /><text x="30" y="10"><tspan>最大震度</tspan><tspan x="30" dy="20" fill="#eedaf2" font-size="20px">{max}</tspan></text></g><g transform="translate(20, 270)" stroke="none"><path d="M22 12L20 13L19 14L18 13L17 16L16 13L15 21L14 13L13 15L12 13L11 17L10 13L9 22L8 13L7 19L6 13L5 14L4 13L2 12L4 11L5 10L6 11L7 5L8 11L9 2L10 11L11 7L12 11L13 9L14 11L15 3L16 11L17 8L18 11L19 10L20 11L22 12Z" /><text x="30" y="10"><tspan>芮氏規模</tspan><tspan x="30" dy="20" fill="#eedaf2" font-size="20px"><tspan>M</tspan><tspan x="50" font-size="12px">L</tspan><tspan> {mag}</tspan></tspan></text></g><g transform="translate(20, 320)" stroke="none"><path d="M16.59,5.59L18,7L12,13L6,7L7.41,5.59L12,10.17L16.59,5.59M16.59,11.59L18,13L12,19L6,13L7.41,11.59L12,16.17L16.59,11.59Z" /><text x="30" y="10"><tspan>震源深度</tspan><tspan x="30" dy="20" fill="#eedaf2" font-size="20px">{depth} 公里</tspan></text></g><text x="150" y="380" fill="#f0f0f0" stroke="none" font-size="14px" text-anchor="middle" opacity="1">實際結果以中央氣象署公佈的內容為準</text></g>',
    "legend": '<g id="legend" transform="translate(10, 900)" font-family="Noto Sans TC, sans-serif"><rect x="0" y="-240" width="80" height="270" fill="#000"/><rect x="10" y="5" width="20" height="20" fill="#387FFF"/><text x="40" y="15.0" fill="#fff" stroke="none" font-size="14" alignment-baseline="middle">1級</text><rect x="10" y="-25" width="20" height="20" fill="#244FD0"/><text x="40" y="-15.0" fill="#fff" stroke="none" font-size="14" alignment-baseline="middle">2級</text><rect x="10" y="-55" width="20" height="20" fill="#35BF56"/><text x="40" y="-45.0" fill="#fff" stroke="none" font-size="14" alignment-baseline="middle">3級</text><rect x="10" y="-85" width="20" height="20" fill="#F8F755"/><text x="40" y="-75.0" fill="#fff" stroke="none" font-size="14" alignment-baseline="middle">4級</text><rect x="10" y="-115" width="20" height="20" fill="#FFC759"/><text x="40" y="-105.0" fill="#fff" stroke="none" font-size="14" alignment-baseline="middle">5弱</text><rect x="10" y="-145" width="20" height="20" fill="#FF9935"/><text x="40" y="-135.0" fill="#fff" stroke="none" font-size="14" alignment-baseline="middle">5強</text><rect x="10" y="-175" width="20" height="20" fill="#DF443B"/><text x="40" y="-165.0" fill="#fff" stroke="none" font-size="14" alignment-baseline="middle">6弱</text><rect x="10" y="-205" width="20" height="20" fill="#7B170F"/><text x="40" y="-195.0" fill="#fff" stroke="none" font-size="14" alignment-baseline="middle">6強</text><rect x="10" y="-235" width="20" height="20" fill="#7237C1"/><text x="40" y="-225.0" fill="#fff" stroke="none" font-size="14" alignment-baseline="middle">7級</text></g>',
    "copyright": '<g id="copyright" transform="translate(0 960)" font-family="Noto Sans TC, sans-serif"><rect width="100%" height="40" fill="#000"/><text x="500" y="15" fill="#fff" font-size="12" stroke="none" text-anchor="middle">HA-TREM2 | ©探索科技, ©居智科技</text><text x="500" y="30" fill="#fff" font-size="12" stroke="none" text-anchor="middle">Taiwan Map Data Provided by SimpleMaps</text></g>',
    "end": "</svg>",
}

OFFSHORE_ZONES = {
    "Pacific Ocean": '<rect x="950" y="0" width="50" height="1000" fill="{mag_color}" opacity="0.1"><animate attributeName="opacity" from="0.1" to="0.5" dur="2s" repeatCount="indefinite"/></rect>',
    "Philippine Sea": '<rect x="0" y="900" width="1000" height="50" fill="{mag_color}" opacity="0.1"><animate attributeName="opacity" from="0.1" to="0.5" dur="2s" repeatCount="indefinite"/></rect>',
    "Taiwan Strait": '<rect x="0" y="0" width="50" height="1000" fill="{mag_color}" opacity="0.1"><animate attributeName="opacity" from="0.1" to="0.5" dur="2s" repeatCount="indefinite"/></rect>',
    "East China Sea": '<rect x="0" y="0" width="1000" height="50" fill="{mag_color}" opacity="0.1"><animate attributeName="opacity" from="0.1" to="0.5" dur="2s" repeatCount="indefinite"/></rect>',
    "Bashi Channel": '<rect x="900" y="900" width="100" height="100" fill="{mag_color}" opacity="0.1"><animate attributeName="opacity" from="0.1" to="0.5" dur="2s" repeatCount="indefinite"/></rect>',
    "South China Sea": '<rect x="0" y="900" width="1000" height="50" fill="{mag_color}" opacity="0.1"><animate attributeName="opacity" from="0.1" to="0.5" dur="2s" repeatCount="indefinite"/></rect>',
    "Sea": """
        <rect x="25" y="0" width="950" height="25" fill="{mag_color}" opacity="0.3" stroke="none"/>
        <rect x="0" y="0" width="25" height="935" fill="{mag_color}" opacity="0.3" stroke="none"/>
        <rect x="975" y="0" width="25" height="935" fill="{mag_color}" opacity="0.3" stroke="none"/>
        <rect x="0" y="935" width="1000" height="25" fill="{mag_color}" opacity="0.3" stroke="none"/>
    """,
}
...
def latlon_to_svg(
    lat,
    lon,
    center_lat=TAIWAN_CENTER[0],
    center_lon=TAIWAN_CENTER[1],
    center_x=658.6,
    center_y=552,
    width=1000,
    height=1000,
...
def generate_qr_code(url, bg_svg, scale=9):
    """Generate QR code for earthquake data."""
...
def draw(eq_data: dict, intensitys: dict, bg_path=None, url=None):
    """Draw the Taiwan map with earthquake data."""

    # Initialize constants
    id_parts = []
    id_parts.append(str(eq_data.get("id", "xxxxxx")))
    id_parts.append(str(eq_data.get("serial", "x")))
    eq_id = "-".join(id_parts)
    eq: dict = eq_data.get("eq", {})
    lat = eq.get("lat", TAIWAN_CENTER[0])
    lon = eq.get("lon", TAIWAN_CENTER[1])
    mag = eq.get("mag", 0)
    loc: str = eq.get("loc", "N/A")
    depth = eq.get("depth", 0)
    time = eq.get("time", datetime.now(TZ_UTC).timestamp() * 1000)
    ...
    # Parse each county and fill in the SVG path
    max_area = {"county_id": "", "intensity": 0}
    for county_id in COUNTY_CENTERS:
        if county_id in TW_MAP_SVG:
            intensity = intensitys.get(county_id, 0)  # Default to 0 if not found

            # Update max_area if current intensity is greater
            if intensity > max_area["intensity"]:
                max_area["county_id"] = county_id
                max_area["intensity"] = intensity

            # Draw the county path with the corresponding intensity color
            intensity_color = INTENSITY_COLORS.get(
                round_intensity(intensity), DEFAULT_COLOR
            )
            path_content = TW_MAP_SVG[county_id].replace(
                f"{{{county_id}_COLOR}}", intensity_color
            )
            svg_parts.append(path_content)

    if eq_id != "xxxxxx-x":
        # Calculate the SVG coordinates for the epicenter
        epicenter_x, epicenter_y = latlon_to_svg(lat, lon)

        # Calculate the color for the epicenter
        ...
        if offshore_area:
            svg_parts.append(
                OFFSHORE_ZONES.get(offshore_area, OFFSHORE_ZONES["Sea"]).format(
                    mag_color=mag_color
                )
            )
        else:
            svg_parts.append(
                f'<line x1="{epicenter_x - 10}" y1="{epicenter_y - 10}" x2="{epicenter_x + 10}" y2="{epicenter_y + 10}" stroke="red" stroke-width="5" />'
            )
            svg_parts.append(
                f'<line x1="{epicenter_x + 10}" y1="{epicenter_y - 10}" x2="{epicenter_x - 10}" y2="{epicenter_y + 10}" stroke="red" stroke-width="5" />'
            )
        ...
        second = formatted_time.strftime("%S")
        ...
        # Parse max intensity
        max_parts = []
        max_parts.append(COUNTY_NAME.get(max_area["county_id"], ""))
        max_parts.append(intensity_to_text(round_intensity(max_area["intensity"])))

        # Append earthquake information
        svg_parts.append(
    ...
    # Check URL
    if url is None:
        serial = eq_data.get("id", "")
        if serial == "":
            url = "https://www.cwa.gov.tw/V8/C/E/index.html"
        else:
            url = f"https://www.cwa.gov.tw/V8/C/E/EQ/EQ{serial}-{month}{day}-{hour}{minute}{second}.html"

    # Create QR Code
    qrcode_svg = generate_qr_code(
        url,
        bg_path,
        11 if serial == "" else 9,
    )
