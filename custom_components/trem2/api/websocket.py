...
class ExpTechWSClient:
    ...
    async def _handle(self, raw_type: WSMsgType, raw_data, extra):
        ...
        match raw_type:
            case WSMsgType.CLOSE | WSMsgType.CLOSED | WSMsgType.CLOSING | WSMsgType.ERROR:
                ...
                try:
                    ...
                    if ex.status == 502:
                        self.state.hass.async_create_task(self.reconnect())
    ...
    async def _parse_text(self, payload: dict):
